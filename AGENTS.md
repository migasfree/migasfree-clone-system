...
- **Server Path**: `http://<SERVER_URL>/pool/mgi/<PROJECT_NAME>/`
- **Local Path**: `/mcsdata/pool/mgi/<PROJECT_NAME>/`
- **Project Directories**:
...
- **Testing**: Use `make qemu-clone`. It simulates a real environment with a target disk `artifacts/target-hd.qcow2`.
